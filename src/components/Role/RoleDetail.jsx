        ...
        <div className="flex justify-center items-center h-full">
            <div className="flex flex-col w-full gap-10">
                <div className="flex w-full justify-between items-center">
                    ...
                    <button className="h-[50px] w-[114px] border border-[#D1D5DB] hover:bg-[#D1D5DB]/20 text-[#374151] font-medium rounded-[6px] flex justify-center items-center gap-3" onClick={() => navigate(`/roles/edit/${id}`, { replace: true })}>Edit <MdModeEditOutline className="text-[#6B7280] text-xl" /> </button>
                </div>
